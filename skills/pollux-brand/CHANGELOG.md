...
- Nuevos assets de mascota informal: familia **PolluxDog** (silueta flat navy #202B56 con ojos pixel 8-bit) — polluxdog.png, DisenoSoloCara, DisenoCompleto con tagline, variante negra. Reglas de uso documentadas en SKILL.md (emails/firmas informales; nunca en documentos formales)
